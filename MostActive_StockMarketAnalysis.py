...
MostActivePercentage = soup.find_all("span", class_ = " V53LMb")
...
for i in MostActivePercentage:
    print(i)
if MostActivePercentage:
    print(True)
    for i in MostActivePercentage:
        if i.get("path")["d"]:
            if i.find("path")["d"] == "M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z":
                ChangeValue = "Down By "
                MostActiveChangeValue_List.append(ChangeValue)
            elif i.find("path")["d"] == "M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z":
                ChangeValue = "Up by "
                MostActiveChangeValue_List.append(ChangeValue)
        else:
