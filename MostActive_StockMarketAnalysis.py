...
MostActivePercentage = soup.find_all("span", class_ = "NydbP VOXKNe")
...
for percentage in MostActivePercentage[3: len(MostActiveCompanyNames_List)]:
    ActualPercentage = percentage["aria-label"]
